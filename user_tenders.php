                    ...
                    <div class="card">
                        ...
                        <header>
                            ...
                            <div class="navbar-right">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addTenderModal">
    ...
    <script>
        ...
        function renderTenders(tenders) {
            ...
            tenders.forEach(tender => {
                ...
                <td>
                    <button class="btn btn-primary btn-sm" onclick="showEditModal(${tender.tender_id})">Edit</button>
                </td>
                 `;
