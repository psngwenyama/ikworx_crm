...
$sql = "UPDATE deals SET owner = ?, company = ?, email = ?, phone = ?, value = ?, stage = ?, priority = ?, assigned = ?, source = ?, deal_date = ?, course_name = ? WHERE deal_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ssssdssssssi", $owner, $company, $email, $phone, $value, $stage, $priority, $assigned, $source, $deal_date, $course_name, $deal_id);
