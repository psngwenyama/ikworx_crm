...
<body>
            ...
            <div class="leads-in">
              <header>
                ...
                <div class="navbar-right">
                  <button class="btn btn-primary" id="newLeadBtn" data-toggle="modal" data-target="#leadModal">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      axios.get('./lead/user_collect_leads.php')
        .then(response => {
                    ...
                    .then(data => {
                        ...
                        data.leads.forEach(lead => {
                            ...
                            row.innerHTML = `
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary btn-edit" data-lead-id="${lead.lead_id}" data-toggle="modal" data-target="#leadModal">Edit</button>
                                </td>
                            `;
